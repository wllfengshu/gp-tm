...
function docReady() {
    ...
    $('.btn-setting_addRole').click(function (e) {//角色管理-- 添加角色
        e.preventDefault();
...
//  });
	...
	$('.btn-setting_permi').click(function (e) {//账号管理-- 账号权限
        e.preventDefault();
        $('#myModal_permi').modal('show');
    });

	$('.btn-setting_third').click(function (e) {//账号管理-- 第三方账号登录
        e.preventDefault();
